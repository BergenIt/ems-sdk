...
После формирования скелета проекта можно перейти к наполнению логикой операции модуля расширения.

В данном разеделе описана логика сбора информации в рамках конкретной системной операции.
