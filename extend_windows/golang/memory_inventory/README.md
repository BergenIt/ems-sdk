...
Реализация операции будет производиться на виртуальной машине, запущенной c помощью программы по виртуализации **VirtualBox** со следующими характеристикам:
